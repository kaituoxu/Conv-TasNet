...
list_dir_tr = os.listdir("/home/ofek.cohen/PycharmProjects/Conv-TasNet/egs/wsj0/wsj0-hin/tt")
...
df.to_csv('/home/ofek.cohen/PycharmProjects/Conv-TasNet/tools/matlab-code/mix_2_spk_tt.txt', index=False, sep=' ',
          header=False)
